    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button
          ...
          className="hidden md:block bg-primary-purple text-primary-text px-6 py-2 rounded-full font-inter font-bold text-sm hover:bg-primary-magenta hover:text-primary-text border-2 border-transparent hover:border-primary-magenta transition-all duration-200"
        >
          Book Strategy Call
        </button>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div className="px-6 py-4 space-y-4">
            ...
            <button
              onClick={handleCTAClick}
              className="w-full bg-primary-purple text-primary-text px-6 py-3 rounded-full font-inter font-bold text-sm hover:bg-primary-magenta hover:text-primary-text border-2 border-transparent hover:border-primary-magenta transition-all duration-200"
            >
              Book Strategy Call
            </button>
          </div>
