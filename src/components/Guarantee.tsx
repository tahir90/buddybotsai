...
const Guarantee: React.FC = () => {
  return (
    <section id="guarantee" className="bg-canvas-navy py-20" role="region" aria-labelledby="guarantee-heading">
        ...
        <div className="grid md:grid-cols-[1.1fr_0.9fr] gap-6 md:gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center space-x-3 bg-elevated-card rounded-full px-8 py-4 border border-primary-purple mb-8">
              <Shield className="w-8 h-8 text-primary-purple" aria-hidden="true" />
            ...
            <h2 id="guarantee-heading" className="text-primary-text font-inter font-bold text-3xl md:text-4xl mb-6 max-w-2xl leading-tight">
          ...
          >
            <img
              src="/ROI.png"
              alt="ROI guarantee mascot - BuddyBots.ai performance promise"
