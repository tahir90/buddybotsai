...
import { Calendar, Search, Cog, Rocket, BarChart3, CheckCircle } from 'lucide-react';
              ...
              return (
                ...
                >
                  ...
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'} text-center md:text-left relative`}>
                    ...
                    {/* 📍 Roadmap Buddy - positioned beside the final step (Week 6) */}
                    {isLastStep && (
                      <motion.div
