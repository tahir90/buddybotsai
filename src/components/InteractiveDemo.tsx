    ...
    <div className="bg-elevated-card rounded-xl border border-neutral-stroke relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 md:p-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h3 className="text-primary-text font-inter font-bold text-xl md:text-2xl mb-2">
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={handlePlay}
              className="bg-primary-purple text-primary-text p-3 rounded-full hover:bg-primary-magenta transition-colors duration-200 group"
            ...
            <button
              onClick={handleReset}
              className="bg-canvas-navy text-body-text p-3 rounded-full hover:text-primary-text hover:bg-neutral-stroke transition-colors duration-200"
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-300 ${
                        ...
                        {isCompleted ? (
                          ...
                          <span className="text-body-text font-inter font-bold text-lg">{index + 1}</span>
                        )}
                      </div>

                      <div>
                        <h4 className={`font-inter font-bold text-lg transition-colors duration-300 ${
                    ...
                    {isActive && !shouldShowResults && (
                      <motion.div
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="w-8 h-8 border-2 border-primary-purple border-t-transparent rounded-full animate-spin"
                      />
                    )}
                      ...
                      >
                        <div className="pt-4 border-t border-neutral-stroke">
                          ...
                          <motion.div
                            ...
                            className="bg-canvas-navy rounded-lg p-4 mb-4"
                          >
                            <div className="flex items-center space-x-2 mb-2">
                              <TrendingUp className="w-5 h-5 text-amber-cta" />
                              <span className="text-amber-cta font-inter font-bold text-sm">Business Impact</span>
                            </div>
                            <p className="text-primary-text font-inter text-sm leading-relaxed">
                              {step.businessImpact}
                            </p>
                          </motion.div>
                          ...
                          <div className="grid grid-cols-3 gap-3">
                            {step.outcomes.map((outcome, outcomeIndex) => (
                              ...
                              >
                                <div className="text-primary-purple font-inter font-bold text-lg mb-1">
                                  {outcome.value}
                                </div>
                                <div className="text-body-text font-inter text-xs leading-tight">
                                  {outcome.metric}
                                </div>
                                <div className="text-secondary-text font-inter text-xs">
                                  {outcome.unit}
                                </div>
                              </motion.div>
                            ))}
        ...
        {currentStep >= demoSteps.length && (
          <motion.div
            ...
            className="mt-8 p-6 bg-gradient-to-r from-success-green to-cyan-400 rounded-xl text-center"
          >
            <CheckCircle className="w-12 h-12 text-white mx-auto mb-4" />
            <h4 className="text-white font-inter font-bold text-xl mb-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-white bg-opacity-20 rounded-lg p-3">
                ...
                <div className="text-white font-inter font-bold text-lg">$285K</div>
                <div className="text-white font-inter text-xs">Annual Savings</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-3">
                <Clock className="w-6 h-6 text-white mx-auto mb-1" />
                <div className="text-white font-inter font-bold text-lg">180hrs</div>
                <div className="text-white font-inter text-xs">Weekly Savings</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-3">
                <TrendingUp className="w-6 h-6 text-white mx-auto mb-1" />
                <div className="text-white font-inter font-bold text-lg">285%</div>
                <div className="text-white font-inter text-xs">ROI Achieved</div>
              </div>
              <div className="bg-white bg-opacity-20 rounded-lg p-3">
                <Users className="w-6 h-6 text-white mx-auto mb-1" />
                <div className="text-white font-inter font-bold text-lg">90 Days</div>
                <div className="text-white font-inter text-xs">To Full ROI</div>
              </div>
            </div>
          </motion.div>
        )}
